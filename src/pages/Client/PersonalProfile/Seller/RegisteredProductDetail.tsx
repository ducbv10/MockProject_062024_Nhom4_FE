...
const RegisteredProductDetail = () => {
  ...
  return (
    <div className="flex flex-col space-y-5 w-full">
      <h1 className="text-[#B7201B] text-center text-2xl md:text-3xl lg:text-4xl font-bold">Product Details</h1>
      ...
      <div className="flex justify-center md:justify-end">
        <button className="bg-[#B7201B] px-8 py-2 rounded-md text-white font-bold text-lg">UPDATE</button>
      </div>
    </div>
  );
}
